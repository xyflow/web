---
description: 'Terms of Use: Legal terms for the Pro platform services, Pro examples, support plans, and usage rights for React Flow Pro subscribers.'
---
...
- (2) Regarding individual Services, that are mentioned in the Service Plans offered by Webkid, the following shall apply:
  ...
  - a) **Access to Pro content (examples, templates and regarding docs):** Pro examples and templates are built on top of the React Flow library. The User may access the source code of all examples and templates for the term of the Service Agreement. The usage, modification, and distribution of pro content is governed by the xyflow Pro License, which is incorporated herein by reference and available at the [xyflow pro license page](/pro-license). Once the Service Agreement ends, the User will not have access to new pro content but retains the rights granted under the Pro License for previously accessed content. The pro content is provided on the React Flow Pro website. The Code is embedded in the website and can be copied or downloaded to the User's environment. Webkid is not liable for the provided source code or any of it's dependencies. Webkid does not provide any guarantee that the code will work in the User's environment.
