...
[🔗 Server side rendering guide](http://localhost:3002/learn/advanced-use/ssr-ssg-configuration)

## 2. Computing flows - hooks and helpers

(use the flow peter made with RGB color nodes - M)
...
[Computing flows guide](http://localhost:3002/learn/advanced-use/computing-flows)

## 3. Dark mode

(include example for dark mode that we already made - M)
...
((new feedback is highly appreciated))

And that’s it for React Flow 12, thanks for sticking around and using React Flow 🌻
