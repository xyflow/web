---
title: 'React Flow v12 Release'
htmlTitle: 'React Flow v12 Release'
intro: 'Server side rendering, computing flows, dark mode, better developer experience with TSDoc, and more'
date: 15 March 2024
authors: ['moritz', 'john']
tags: ['react-flow']
...
Since v11, we’ve grown our core team to five people, reached nearly 20k stars on github, rebranded to xyflow, launched Svelte Flow (many great side-effects of this are baked into this release), and kept all of our office plants alive.

And now, we've prepared a chunky v12 release for y'all 🎁 It comes with a few much-asked for major features, as well as tons of bug/performance clean-up as a result of combing through every. line. of. code. while developing Svelte Flow.
...
React is heading towards server side rendering, with tools like [Nextjs](https://nextjs.org/), [Astro](https://astro.build/), and [waku](https://waku.gg/). We’ve gotten asked to do server side rendering more than a [couple](https://github.com/xyflow/xyflow/issues/3168) of [times](https://github.com/xyflow/xyflow/issues/3384) due to difficulties using React Flow with these tools. For exampole, with React Flow v11 Astro just renders a React Flow diagram as blank by default- that’s no good.
...
Check out our [server side rendering guide](http://localhost:3002/learn/advanced-use/ssr-ssg-configuration) for the full scoop.
