...
- It would be too complicated to build the things we wanted to build while also
  making the components flexible enough to be styled or used in different
  applications.
...
- A [**database schema node**](https://reactflow.dev/components/database-schema-node)
...
- A [**zoom slider**](https://reactflow.dev/components/zoom-slider) for more
