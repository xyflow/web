...
import { BlogPostLayout, Embed, Image, Emoji } from 'xy-ui';
...
**[Resize and Rotate](https://reactflow.dev/docs/examples/nodes/resize-rotate/):** This was a Pro example, but we decided to make the source code available to everyone in our public docs to avoid trouble people were having with third-party resizing libraries. We also refactored the code to use the new [resizer component](https://reactflow.dev/docs/api/nodes/node-resizer/).
