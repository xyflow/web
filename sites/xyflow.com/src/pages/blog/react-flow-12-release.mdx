...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/dark-mode/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/dark-mode/index.html`}
    showEditor={false}
    framework="react"
  />
</Bleed>
