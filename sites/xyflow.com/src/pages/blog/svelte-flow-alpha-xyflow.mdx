...
- New [`nodeDragThreshold` prop](/docs/api/react-flow-props/#nodedragthreshold) to delay node drag events [11.9.0](https://github.com/wbkd/react-flow/blob/main/packages/reactflow/CHANGELOG.md)
