...
- New [`nodeDragThreshold` prop](https://reactflow.dev/api-reference/react-flow/#nodedragthreshold) to delay node drag events [11.9.0](https://github.com/wbkd/react-flow/blob/main/packages/reactflow/CHANGELOG.md)
