---
title: 'Team Update – Welcoming Peter, Svelte Flow alpha and v11.9.0'
intro: "Try out the Svelte Flow alpha, many fixed React Flow bugs, our name will change to “xyflow” soon, and we're welcoming Peter to the core team."
date: 2023/09/26
authors: ['john']
...
import { Image, Emoji } from '@xyflow/xy-ui';
...
- New [`nodeDragThreshold` prop](https://reactflow.dev/api-reference/react-flow/#nodedragthreshold) to delay node drag events [11.9.0](https://github.com/xyflow/xyflow/blob/main/packages/reactflow/CHANGELOG.md)
- Compatibility with Astro, Remix, and older setups like webpack4 and React 17 [11.9.0](https://github.com/xyflow/xyflow/blob/main/packages/reactflow/CHANGELOG.md)
- Improved performance for larger graphs with minimap [#3153](https://github.com/xyflow/xyflow/pull/3153)
- Better key defaults and scroll behavior for Windows users [11.8.0](https://github.com/xyflow/xyflow/blob/main/packages/reactflow/CHANGELOG.md#1180)
- Better default edge routing and label positions [11.8.0](https://github.com/xyflow/xyflow/blob/main/packages/reactflow/CHANGELOG.md)

And so, so many bugs have been squashed. Old bugs, new bugs. We feel like 6 year olds who just found an ant hill. For a comprehensive list, here's our [changelog](https://github.com/xyflow/xyflow/blob/main/packages/reactflow/CHANGELOG.md).
...
You can check out our [Github Readme](https://github.com/xyflow/xyflow/tree/xyflow/packages/svelte#svelte-flow-alpha) and reference our React Flow docs while we create the Svelte Flow docs. Because we are in alpha, the API is likely to change.
