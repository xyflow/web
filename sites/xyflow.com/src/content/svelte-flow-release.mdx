...
Big shoutout goes out to the Svelte team for their help during the turbulent era of the Svelte 5 Release Candidate! Fixes were delivered either within a couple of [hours](https://github.com/sveltejs/svelte/issues/12652) or sometimes in a matter of [minutes](https://github.com/sveltejs/svelte/issues/12302)!?
...
A collaborative API testing workspace utilizing Svelte Flow for visualizing shape and status of test runs.
