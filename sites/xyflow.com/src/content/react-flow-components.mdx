...
realized there was a big downside to taking this approach. Compared to similar
libraries, React Flow is designed to be fairly low-level and with a high amount of
customizability. How would users customize and style components hidden away inside
a library?
