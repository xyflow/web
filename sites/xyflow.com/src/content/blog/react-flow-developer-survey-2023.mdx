...
3. **Where our users go to get help.** We spend a lot of time on our documentation so it's important to know that time is being spent in the right places. We have analytics to tell us what pages are popular, but if folks are heading somewhere else to get help then that can tell us something too!
