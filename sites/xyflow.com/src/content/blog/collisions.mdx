...
**Spoiler Alert:** It turns out we may have just created a blazingly fast algorithm — one
...
number of nodes — kind of like running a Kubernetes cluster for a website with ten monthly
visitors (one of them being my mum) — doesn’t tell you much about everyday performance.
