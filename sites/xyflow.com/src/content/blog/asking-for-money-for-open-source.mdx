...
We maintain [React Flow](https://github.com/xyflow/xyflow), an open source library for making node-based UIs. Our story developed in a similar way to some other lucky libraries:
...
<Bleed>
  <Image
    ...
    wide
    caption="Our Free plan is the open source library as-is. The Starter and Pro
      plans have a few extras that users can pay for with a monthly subscription,
      like prioritized bug reports and email support."
  />
</Bleed>
