---
title: Elkjs Tree
description: "If you're looking for a more powerful alternative to dagre, you can also use elkjs to layout your Svelte Flow graphs."
---
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/layout/elkjs/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/layout/elkjs/index.html`}
  framework="svelte"
