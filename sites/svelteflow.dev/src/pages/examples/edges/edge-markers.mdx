...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/edges/edge-markers/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/edges/edge-markers/index.html`}
  framework="svelte"
/>
</ExampleLayout>
