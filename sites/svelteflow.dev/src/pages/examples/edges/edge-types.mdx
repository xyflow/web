...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/edges/edge-types/source.json`} 
  preview={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/edges/edge-types/index.html`}
  framework="svelte"
/>
</ExampleLayout>
