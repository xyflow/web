---
title: Edge Labels
description: Rendering labels on edges in Svelte Flow. Uses Edge Label Renderer internally.
---
...
export const getStaticProps = getStaticCode(['examples/edges/edge-label']);
...
<RemoteCodeViewer
  route="examples/edges/edge-label"
  framework="svelte"
/>
</ExampleLayout>
