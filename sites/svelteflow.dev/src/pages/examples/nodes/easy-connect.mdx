...
<ExampleLayout>
  ...
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/nodes/easy-connect/source.json`}
    preview={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/nodes/easy-connect/index.html`}
    framework="svelte"
  />
</ExampleLayout>
