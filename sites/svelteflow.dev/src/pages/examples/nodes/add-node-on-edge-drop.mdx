...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/nodes/add-node-on-drop/source.json`}
  preview={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/nodes/add-node-on-drop/index.html`}
  framework="svelte"
/>
</ExampleLayout>
