...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/nodes/add-node-on-drop/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/nodes/add-node-on-drop/index.html`}
  framework="svelte"
/>
</ExampleLayout>
