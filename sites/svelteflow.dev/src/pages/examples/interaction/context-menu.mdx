...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/interaction/context-menu/source.json`}
  preview={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/interaction/context-menu/index.html`}
  framework="svelte"
/>
