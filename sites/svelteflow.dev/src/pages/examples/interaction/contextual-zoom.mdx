...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/interaction/contextual-zoom/source.json`}
  preview={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/examples/interaction/contextual-zoom/index.html`}
  framework="svelte"
/>
</ExampleLayout>
