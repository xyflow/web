...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/interaction/contextual-zoom/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/examples/interaction/contextual-zoom/index.html`}
  framework="svelte"
/>
</ExampleLayout>
