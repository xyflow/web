...
import {
  ...
  intersectionFields,
  viewportFields,
} from '@/page-data/react-flow/api/types/ReactFlowInstance.fields.ts';
...
[`useReactFlow`](../hooks/useReactFlow) hook or attaching a listener to the
[`onInit`](../ReactFlow#event-oninit) event.
