...
description:
  ...
  is a portal that renders the label in a div that is positioned on top of the
  edges.
---
...
[edge label renderer](/examples/edges/edge-label-renderer) example. We are using
