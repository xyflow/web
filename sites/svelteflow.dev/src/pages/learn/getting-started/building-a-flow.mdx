...
As the nodes, the edges have a lot of options too. You can chosse a type, define start and end markers, labels and of course change the styling. You can see the full list of options on the [edge option site](/api-reference/types/edge).
