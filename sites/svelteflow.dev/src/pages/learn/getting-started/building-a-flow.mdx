...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/a/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/a/index.html`}
  framework="svelte"
  editorHeight={400}
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/b/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/b/index.html`}
  framework="svelte"
  editorHeight={400}
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/c/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/c/index.html`}
  framework="svelte"
  editorHeight={400}
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/d/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/getting-started/d/index.html`}
  framework="svelte"
  editorHeight={400}
/>
