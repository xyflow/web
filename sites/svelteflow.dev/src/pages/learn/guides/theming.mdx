...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/theming/a/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/theming/a/index.html`}
  framework="svelte"
  editorHeight={500}
/>
## Base styles
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/theming/b/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/svelte/guides/theming/b/index.html`}
  framework="svelte"
  editorHeight={500}
/>
## Customization
