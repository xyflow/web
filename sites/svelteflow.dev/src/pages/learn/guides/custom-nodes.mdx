...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/guides/custom-nodes/a/source.json`}
  preview={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/guides/custom-nodes/a/index.html`}
  framework="svelte"
  editorHeight={500}
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/guides/custom-nodes/b/source.json`}
  preview={`${process.env.NEXT_PUBLIC_SVELTE_EXAMPLES_URL}/guides/custom-nodes/b/index.html`}
  framework="svelte"
  editorHeight={500}
/>
