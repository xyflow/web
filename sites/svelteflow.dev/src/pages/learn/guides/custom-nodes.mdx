...
<Callout type="warning">
  ...
  You have to forward on:connect, on:connectstart and on:connectend on the handles
  for the events to be fired on the wrapper component. This will likely change in
  the future.
</Callout>
