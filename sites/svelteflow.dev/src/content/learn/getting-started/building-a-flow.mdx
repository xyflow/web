...
To make the flow much more user friendly we should add some additional functinality. Let's import the `Minimap` and the `Controls` components and add overlay them on the viewport.
