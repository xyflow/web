...
<div id="016" />
### Edge with id "yourId" does not exist, it may have been removed.

This can happen when an edge is deleted before the edge click/selection handler is called.

As the warning says, this can happen when you are trying to access an edge that has
