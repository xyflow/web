...
- **Keyboard navigation & A11y**: We added support for keyboard navigation and improved accessibility for screen readers. You can now tab through nodes and edges and move nodes with the arrow keys.
...
- [**elevateNodesOnSelect**](/api-reference/svelte-flow#elevateNodesOnSelect) prop: Control if nodes should be elevated via z-index when selected.
