...
step. If you haven't reviewed our [Key Concepts](/learn/getting-started/terms-and-definitions) yet,
...
This all might already go into the right direction but it still looks a little bland and
lopsided, doesn't it?
