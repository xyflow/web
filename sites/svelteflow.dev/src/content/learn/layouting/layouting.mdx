...
import { LayoutingLibrariesTable } from 'xy-shared/components/learn/layouting-libraries';
...
<RemoteCodeViewer route="learn/layouting-flow-1-empty" framework="svelte" />
...
<RemoteCodeViewer route="learn/layouting-flow-2-dagre" framework="svelte" />
...
<RemoteCodeViewer route="learn/layouting-flow-3-d3-hierarchy" framework="svelte" />
...
<RemoteCodeViewer route="learn/layouting-flow-4-d3-force" framework="svelte" />
...
<RemoteCodeViewer route="learn/layouting-flow-6-elkjs" framework="svelte" />
