---
description:
  This guide gives you an overview of utility classes in Svelte Flow that help you control
...
[`noPanClass`](/api-reference/svelte-flow#style-props) prop on `<SvelteFlow />`.
