---
description: This guide shows you how to add handles to custom nodes in Svelte Flow.
---
...
[`<Handle />`](/api-reference/components/handle) component provided by Svelte Flow. This
...
<RemoteCodeViewer route="learn/custom-node-2" framework="svelte" />
...
<div class="svelte-flow__node-default">
  ...
  >
    <span
      style="pointer-events: none; font-size: 1em; left: 0; position: absolute;"
      aria-hidden="true"
      >→</span
    >
  </Handle>
...
`<SvelteFlow />` component. This allows the handle to be used for both incoming and
