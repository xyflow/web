---
description: When you implement a custom node it is wrapped in a component that enables
...
When you implement a [custom node](/learn/customization/custom-nodes) it is wrapped in a component that enables basic functionality like drag, select and remove. A custom node gets the following props:
