...
If you want a way to make your edges updatable, you can use the `<EdgeReconnectAnchor />` component. This component is used to create a reconnection point on your custom edges. These points behave the same way as handles:
