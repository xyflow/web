          ...
          {projectType && (
            <div className="flex mb-4">
              ...
              <label className="text-muted-foreground text-sm" htmlFor="confirm">
                {projectType === 'student'
                  ? 'I confirm that I am using Svelte Flow Pro only for educational purposes.'
                  : 'I confirm that I am using Svelte Flow Pro only for non-commercial purposes in my open source project.'}
              </label>
            </div>
          )}
          <Button
