...
<figure>
  ...
  />
  <figcaption>
    This is <a href="https://bleep.cafe">bleep.cafe</a>. We're going to learn
    everything we need to know to build something just like it!
  </figcaption>
</figure>
...
ReactDOM.createRoot(root).render(
  <React.StrictMode>
    // React flow needs to be inside an element with a known height and width to
    work
...
<Tabs items={['audio.js', 'store.js', 'App.jsx']}>
  <Tab>
