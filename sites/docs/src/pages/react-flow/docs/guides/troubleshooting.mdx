...
<Alert status="error">This will cause an error:</Alert>
...
<Alert status="error">This will cause an error, too:</Alert>
...
<Alert status="success">This works:</Alert>
...
<Alert status="error">Causes a warning:</Alert>
...
<Alert status="success">Recommended implementation:</Alert>
...
<Alert status="success">Alternative implementation:</Alert>
...
<Alert status="error">Doesn't work:</Alert>
...
<Alert status="error">Doesn't work either:</Alert>
...
<Alert status="success">This does work:</Alert>
...
<Alert status="error">This will cause the warning:</Alert>
...
<Alert status="success">Working example:</Alert>
...
<Alert status="error">Does show a warning:</Alert>
...
<Alert status="success">Warning resolved:</Alert>
...
<Alert status="error">Will show a warning:</Alert>
