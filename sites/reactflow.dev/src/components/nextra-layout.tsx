...
import { Button, Footer as XYFooter, LogoLabel } from '@xyflow/xy-ui';
...
}> = ({ children, pageMap, footerCategories }) => {
  return (
    <Layout
      darkMode={false}
      ...
      footer={<XYFooter categories={footerCategories} baseUrl="https://reactflow.dev" />}
      navbar={navbar}
