...
CRDTs trade some complexity for availability: they simplify conflict resolution
and offline collaboration, but require careful design to ensure that merge
functions and operations preserve the necessary properties.
...
### The MultiplayerFlow State: Syncing nodes and edges
...
you must then provide react flow with nodes and edges array
