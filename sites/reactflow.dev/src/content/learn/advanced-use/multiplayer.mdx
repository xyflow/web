...
to use a solution that handles disconnects more agressively and is able to discard
...
- **CRDT libraries**, on the other hand, will make your life easier around offline-first
...
| Solution                                                         | Architecture                    | Offline Support              | Conflict Resolution                                         | Notes                                                                                                                                                                                                  |
| ---------------------------------------------------------------- | ------------------------------- | ---------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| [**LiveBlocks**](https://liveblocks.io/)                         | Server-authoritative, CRDT-like | 🟡 Partially offline support | Uses CRDTs under the hood                                   | Real-time collaboration platform with hosted proprietary backend. [React Flow Example](https://liveblocks.io/examples/collaborative-flowchart/zustand-flowchart).                                      |
| [**Velt** for React Flow](https://velt.dev/libraries/react-flow) | CRDT with managed backend       | ✅ Full offline support      | Uses CRDTs under the hood                                   | Collaborative editing platform with managed backend, with a dedicated [React Flow Library](https://docs.velt.dev/realtime-collaboration/crdt/setup/reactflow)                                          |
