...
[See example code](/examples/whiteboard/freehand-draw)
...
[See example code](/examples/whiteboard/lasso-selection)
...
[See example code](/examples/whiteboard/eraser)
...
[See example code](/examples/whiteboard/rectangle)
