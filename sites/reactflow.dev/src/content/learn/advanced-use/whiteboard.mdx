...
<Callout type="info">
  React Flow is not made for creating whiteboard applications, but if you want to
  integrate common whiteboard features into your app, these examples will help you to get
  started.
</Callout>
