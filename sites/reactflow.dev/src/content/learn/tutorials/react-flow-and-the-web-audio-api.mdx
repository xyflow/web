...
import { Callout, Tabs, Bleed } from 'nextra/components';
import { Embed, Image, TutorialLayout } from 'xy-shared';
...
<Bleed>
  <RemoteCodeViewer
    route="tutorials/webaudio/state-management"
    framework="react"
  />
</Bleed>
...
of the [`<Panel />`](https://reactflow.dev/docs//api-reference/components/panel/)
plugin component.
