...
import { TutorialLayout } from 'xy-shared';
...
<Bleed>
  <RemoteCodeViewer
    route="tutorials/mindmap/store-nodes-edges"
    framework="react"
  />
</Bleed>
...
<RemoteCodeViewer
  route="tutorials/mindmap/custom-nodes-edges"
  framework="react"
/>
...
<Bleed>
  <RemoteCodeViewer
    route="tutorials/mindmap/node-as-handle"
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    route="tutorials/mindmap/node-as-handle-2"
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    route="tutorials/mindmap/node-as-handle-3"
    framework="react"
  />
</Bleed>
