...
<div id="012" />
### Node with id yourId does not exist, it may have been removed.
...
Please import '@xyflow/react/dist/style.css' or base.css to make sure
...
happen when you are trying to drag a node that has not been initialized with the
`onNodesChange` handler. Please make sure to use the `onNodesChange` handler to initialize
your nodes properly. You can learn more about this in the
["Adding Interactivity" guide](/learn/concepts/adding-interactivity)
