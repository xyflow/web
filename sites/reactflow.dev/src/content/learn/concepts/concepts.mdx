...
The fundamental building blocks of React Flow include nodes, edges, handles, a connection line and the viewport. 
Let's examine each of these core elements in more detail.
...
and you can find all the options for customizing your nodes in the [Node Options](/api-reference/types/node) documentation.
...
The connection line also comes with four types built in and is customizable. 
