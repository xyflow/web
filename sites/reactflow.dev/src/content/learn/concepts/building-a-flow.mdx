...
and explain how to create a basic interactive flow.
A flow consists of [nodes](/api-reference/types/node), [edges](/api-reference/types/edge) and the viewport.
...
Outside of your React component, create an array of [node](/api-reference/types/node) objects.
