...
Handles are the connection points on [nodes](/learn/concepts/terms-and-definitions#nodes) in React Flow. Our standard nodes include one source and ond target handle, but you can customize your nodes with as many different handles as you need.
