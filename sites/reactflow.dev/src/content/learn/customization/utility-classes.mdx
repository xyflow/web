---
description: This guide gives you an overview of utility classes in React Flow that help you control interactions within custom nodes.
---
...
export default function CustomNode(props: NodeProps) {
  return (
    <div className="nopan" style={{ overflow: 'auto' }}>
