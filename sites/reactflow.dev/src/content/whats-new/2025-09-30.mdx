...
Read more about available codemods in the [shadcn/ui Tailwind CSS 4 upgrade guide](https://ui.shadcn.com/docs/tailwind-v4).
...
Instead of importing your `@xyflow/react/dist/style.css` file in your `App.tsx`, you will need to it in your `global.css` file, 
