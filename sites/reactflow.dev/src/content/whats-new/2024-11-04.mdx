...
- A database schema node that makes it easy to visualize tables and relationships
  between columns.
...
If you want to read the entire release blog post, you can find it on the xyflow
