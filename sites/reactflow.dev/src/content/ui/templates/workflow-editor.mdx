...
description:
  A Next.js-based application designed to help you quickly create, manage, and visualize
  workflows.
is_pro_example: true
---
...
<ProExampleViewer slug="workflow-editor" type="template" framework="react" />
