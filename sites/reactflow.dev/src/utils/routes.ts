...
export type InternalRoute =
  ...
  | '/examples/interaction/copy-and-paste'
  ...
  | '/examples/layout/workflow-builder-starter'
  ...
  | '/examples/nodes/resize-rotate-moveable-deprecated'
  ...
  | '/learn/getting-started/updating-a-flow'
