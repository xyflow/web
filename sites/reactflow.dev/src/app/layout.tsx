...
const navbar = (
  <Navbar
    className="justify-start [&>div]:me-0"
    logo={
  ...
  >
    <ClientNavbar>
      ...
      <Anchor className={classes.tocLink} href="https://discord.gg/RVmnytFmGW">
        <svg
          className="nav-github-logo"
          fill="currentColor"
          viewBox="0 0 130 90"
...
const Toc: FC = async () => {
  ...
  return (
    <div className="grid gap-2 x:text-xs x:font-medium">
      <Anchor className={classes.tocLink} href="https://xyflow.com/contact">
      ...
      {[...changelog, { route: '/whats-new', title: '...and more!' }]
        .slice(0, 3)
        .map(({ route, title }) => (
          <Anchor className={classes.tocLink} href={route} key={route}>
            {title}
          </Anchor>
        ))}
    </div>
