...
/**
 * ⚠️ Attention!
 * This component must be in a separate file.
 *
 * If the root layout is dynamic at runtime, all children beneath it are rendered dynamically too.
 */
export const LayoutDynamic: FC<{ children: ReactNode }> = async ({ children }) => {
  ...
  return (
    ...
    >
      <SubscriptionProvider value={subscriptionContext}>{children}</SubscriptionProvider>
    </NextraLayout>
  );
};
