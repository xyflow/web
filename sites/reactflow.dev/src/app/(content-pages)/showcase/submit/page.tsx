  ...
  return (
    <BaseLayout>
      <Hero
        ...
        subtitle="Thank you for submitting your project to our showcase! Please note that by submitting a showcase here, it is not guaranteed that we will add your project. Accepted projects will appear on the React Flow website."
        align="center"
        backgroundVariant="gradient"
      />
      <ShowcaseForm library="React Flow" />
    </BaseLayout>
  );
};
