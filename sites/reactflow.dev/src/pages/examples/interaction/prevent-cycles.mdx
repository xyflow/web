...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/prevent-cycles/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/prevent-cycles/index.html`}
  framework="react"
/>
