...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/collision-detection/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/collision-detection/index.html`}
  framework="react"
/>
