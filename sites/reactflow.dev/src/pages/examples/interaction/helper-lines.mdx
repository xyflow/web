...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/helper-lines/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/helper-lines/index.html`}
  framework="react"
/>