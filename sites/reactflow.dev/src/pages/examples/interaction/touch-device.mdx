...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/touch-device/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/touch-device/index.html`}
  framework="react"
/>
