...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/save-and-restore/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/interaction/save-and-restore/index.html`}
  framework="react"
/>
