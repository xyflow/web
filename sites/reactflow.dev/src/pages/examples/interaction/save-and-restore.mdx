...
<ExampleLayout>
If you want to save and restore a flow you can use the [`toObject` function](/api-reference/types/ReactFlowInstance/#toObject) of the React Flow instance or your local nodes and edges state.
