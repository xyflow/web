...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/styled-components/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/styled-components/index.html`}
  framework="react"
/>
