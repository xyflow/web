...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/tailwind/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/tailwind/index.html`}
  framework="react"
/>
