...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/static-server-side-generation/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/static-server-side-generation/index.html`}
  framework="react"
/>