...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/download-image/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/download-image/index.html`}
  framework="react"
/>
