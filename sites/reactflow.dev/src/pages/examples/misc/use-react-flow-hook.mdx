...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/use-react-flow-hook/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/use-react-flow-hook/index.html`}
  framework="react"
/>
