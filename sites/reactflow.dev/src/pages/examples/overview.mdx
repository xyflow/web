...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/overview/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/misc/overview/index.html`}
  framework="react"
/>
