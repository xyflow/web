...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/elkjs/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/elkjs/index.html`}
  framework="react"
/>
