...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/elkjs-multiple-handles/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/elkjs-multiple-handles/index.html`}
  framework="react"
/>
