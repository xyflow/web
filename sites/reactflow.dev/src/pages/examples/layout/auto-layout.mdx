...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/auto-layout/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/auto-layout/index.html`}
  framework="react"
/>