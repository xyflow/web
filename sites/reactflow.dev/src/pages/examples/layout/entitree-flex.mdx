...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/entitree-flex/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/entitree-flex/index.html`}
  framework="react"
/>
