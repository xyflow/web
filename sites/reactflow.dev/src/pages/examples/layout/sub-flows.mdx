...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/sub-flows/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/layout/sub-flows/index.html`}
  framework="react"
/>
