...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/edges/animating-edges-svg/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/edges/animating-edges-svg/index.html`}
  framework="react"
/>
