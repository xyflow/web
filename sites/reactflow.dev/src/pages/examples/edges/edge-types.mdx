...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/edges/edge-types/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/edges/edge-types/index.html`}
  framework="react"
/>
