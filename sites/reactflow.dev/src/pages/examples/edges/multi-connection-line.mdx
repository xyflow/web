...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/edges/multi-connection-line/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/edges/multi-connection-line/index.html`}
  framework="react"
/>
