...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/shapes/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/shapes/index.html`}
  framework="react"
/>