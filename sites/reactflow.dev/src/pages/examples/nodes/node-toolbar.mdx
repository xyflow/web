...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/node-toolbar/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/node-toolbar/index.html`}
  framework="react"
/>
