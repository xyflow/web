...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/add-node-on-edge-drop/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/add-node-on-edge-drop/index.html`}
  framework="react"
/>
</ExampleLayout>
