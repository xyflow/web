...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/resize-rotate/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/resize-rotate/index.html`}
  framework="react"
/>
