...
<Callout type="info">
This used to be a pro example using the [moveable](https://www.npmjs.com/package/moveable)
library. Because React Flow now supports resizing through the
[NodeResizer component](/api-reference/components/node-resizer), the pro example
has been deprecated!
...
<ExampleViewer
  ...
  additionalFiles={['ResizeRotateNode.js', 'nodes-edges.js', 'style.module.css']}
/>
</ExampleLayout>
