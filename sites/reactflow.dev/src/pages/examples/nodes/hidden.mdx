...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/hidden/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/nodes/hidden/index.html`}
  framework="react"
/>
