...
To build custom resize controls, you can use the [NodeResizeControl](./node-resize-control) component and customize it.

## Notes

- Take a look at the docs for the [`NodeProps`](../types/node-props) type or the
