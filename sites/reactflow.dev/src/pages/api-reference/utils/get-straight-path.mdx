---
title: Api Reference | getStraightPath()
---
...
[Source on GitHub](https://github.com/wbkd/react-flow/blob/bacaa99c73b347856f63c5d495f5a0829be1e431/packages/core/src/components/Edges/StraightEdge.tsx/#L14)

Calculates the straight line path between two points.

```js
import { Position, getStraightPath } from 'reactflow';
