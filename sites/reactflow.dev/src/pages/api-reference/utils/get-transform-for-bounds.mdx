...
- This is quite a low-level utility. You might want to look at the
  [`fitView`](../types/react-flow-instance#fitview) or
  [`fitBounds`](../types/react-flow-instance#fitbounds) methods for a more practical
  api.
- This function is called get**Transform**... for historical reasons. Its return
  type represents a [`Viewport`](../types/viewport) in tuple form.
