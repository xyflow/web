...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/mini-map/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/mini-map/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/controls/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/controls/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/background/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/background/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/panel/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/panel/index.html`}
  framework="react"
/>
