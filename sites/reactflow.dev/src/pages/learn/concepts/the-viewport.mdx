...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/zoom-pan/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/zoom-pan/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/zoom-pan-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/zoom-pan-2/index.html`}
  framework="react"
/>
