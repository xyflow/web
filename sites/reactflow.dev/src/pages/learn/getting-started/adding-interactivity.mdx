...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/make-it-interactive-1/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/make-it-interactive-1/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/make-it-interactive-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/make-it-interactive-2/index.html`}
  framework="react"
/>
