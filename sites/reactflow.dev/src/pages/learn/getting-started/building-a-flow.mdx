...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-1/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-1/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-2/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-3/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-3/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-4/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-4/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-5/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/getting-started-5/index.html`}
  framework="react"
/>
