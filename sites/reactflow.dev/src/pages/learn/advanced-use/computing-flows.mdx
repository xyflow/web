...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-6/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-6/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing/index.html`}
  framework="react"
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-2/index.html`}
  framework="react"
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-3/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-3/index.html`}
  framework="react"
  activeFile="ColorPreview.jsx"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-4/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-4/index.html`}
  framework="react"
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-5/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/computing-5/index.html`}
  framework="react"
  activeFile="Lightness.jsx"
/>
