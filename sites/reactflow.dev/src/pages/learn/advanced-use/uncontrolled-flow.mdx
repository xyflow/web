...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/uncontrolled/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/uncontrolled/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/uncontrolled-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/uncontrolled-2/index.html`}
  framework="react"
/>
