...
<Callout type="info">
  This is an ongoing experiment on implementing our own React Flow devtools. While
  we are working on the actual package, we'd love to hear about your feedback and
  ideas on [Discord](https://discord.gg/Bqt6xrs) or via mail at info@xyflow.com.
</Callout>
...
The `computed` property is added to each node by React Flow after it has measured
