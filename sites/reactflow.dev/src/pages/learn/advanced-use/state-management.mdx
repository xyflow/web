...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/state-management/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/state-management/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/state-management-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/state-management-2/index.html`}
  framework="react"
