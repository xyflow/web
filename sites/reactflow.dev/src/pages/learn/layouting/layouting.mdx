...
you can refer back to [here](/examples/layout/dagre/)
...
<Callout>
  In this example we use `Element.getBoundingClientRect` to get the dimensions
  of each node. You should think twice about doing this in your own apps if you
  allow zooming: the dimensions of the nodes will change as the user zooms in
  and out!
  <></>
