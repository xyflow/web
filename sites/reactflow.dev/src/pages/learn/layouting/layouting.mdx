...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-1-empty/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-1-empty/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-2-dagre/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-2-dagre/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-3-d3-hierarchy/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-3-d3-hierarchy/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-4-d3-force/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-4-d3-force/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-6-elkjs/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/layouting-flow-6-elkjs/index.html`}
  framework="react"
/>
