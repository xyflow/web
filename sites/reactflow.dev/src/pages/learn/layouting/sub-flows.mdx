...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/sub-flows/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/sub-flows/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/sub-flows-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/learn/sub-flows-2/index.html`}
  framework="react"
/>
