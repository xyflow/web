...
- A callback for what to do when [nodes change](/api-reference/ReactFlow/#onNodeschange).
- A callback for what to do when [edges change](/api-reference/ReactFlow/#onEdgesChange).
- A callback for what to do when nodes are [connected](/api-reference/ReactFlow/#onConnect).
