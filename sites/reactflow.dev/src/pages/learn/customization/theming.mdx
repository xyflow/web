...
<RemoteCodeViewer
  showEditor={false}
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/default-style/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/default-style/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  showEditor={false}
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/base-style/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/examples/styling/base-style/index.html`}
  framework="react"
/>
