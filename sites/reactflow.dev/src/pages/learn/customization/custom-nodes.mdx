...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-node/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-node/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-node-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-node-2/index.html`}
  framework="react"
/>
