...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-edge/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-edge/index.html`}
  framework="react"
/>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-edge-2/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/learn/custom-edge-2/index.html`}
  framework="react"
/>
