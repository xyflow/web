...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/app/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/app/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/scaffold/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/scaffold/index.html`}
    showEditor={false}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/rendering-markdown/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/rendering-markdown/index.html`}
    showEditor={false}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/layout-demo/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/layout-demo/index.html`}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/focus-on-click/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/focus-on-click/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/slide-controls/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/presentation/slide-controls/index.html`}
    framework="react"
  />
</Bleed>
