---
title: 'Integrate with the Web Audio API'
...
<Bleed>
  <Embed src="https://wbkd.github.io/react-flow-web-audio/" />
</Bleed>
...
<Image
  src="/img/blog/webaudio/empty-flow.png"
...
some [helper](/api-reference/utils/applyNodeChanges)
[functions](/api-reference/utils/applyEdgeChanges) to apply those changes
