...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/mouse-theremin/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/mouse-theremin/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/state-management/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/state-management/index.html`}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/custom-node/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/custom-node/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/custom-nodes/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/custom-nodes/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/hardcoded-audio/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/hardcoded-audio/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/demo/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/webaudio/demo/index.html`}
    framework="react"
  />
</Bleed>
