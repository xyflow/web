...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/app/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/app/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/getting-started/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/getting-started/index.html`}
    framework="react"
    showEditor={false}
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/store-nodes-edges/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/store-nodes-edges/index.html`}
    framework="react"
  />
</Bleed>
...
<RemoteCodeViewer
  source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/custom-nodes-edges/source.json`}
  preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/custom-nodes-edges/index.html`}
  framework="react"
/>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/create-nodes/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/create-nodes/index.html`}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle/index.html`}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle-2/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle-2/index.html`}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle-3/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle-3/index.html`}
    framework="react"
  />
</Bleed>
...
<Bleed>
  <RemoteCodeViewer
    source={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle-4/source.json`}
    preview={`${process.env.NEXT_PUBLIC_EXAMPLES_URL}/react/tutorials/mindmap/node-as-handle-4/index.html`}
    framework="react"
