...
Before you can use the [new features](https://github.com/xyflow/xyflow/discussions/3764) that come with React Flow 12 like server side rendering, computing flows, and dark mode, here are the breaking changes you'll have to address first.
