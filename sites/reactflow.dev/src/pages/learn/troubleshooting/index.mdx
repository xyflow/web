...
A possible solution is to wrap your component with a [`<ReactFlowProvider />`](/api-reference/ReactFlowProvider) or move the code that is accessing the state inside a child of your React Flow instance.
