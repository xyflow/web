---
title: Prioritizing an intuitive UI for end users with Carto's Workflows
...
<QandA
  ...
  Flow?"
  answer="We wanted to provide our final users with a very easy-to-use & intuitive UI so that they can create, share, and execute analytical processes using spatial data. This has been traditionally done just by a few specialists, with a big knowledge in the Spatial SQL domain and hard-to-use environments (complex desktop tools, CLI…)."
/>

<QandA
  question="How are you currently using React Flow?"
  answer="We are using React Flow for our “Workflows”, which is our main visual tool to automate data preparation & analysis pipelines with a no-code workflow approach. It's integrated with our Workspace & Builder tools (for asset management & maps creation). More information at https://carto.com/workflows."
/>
