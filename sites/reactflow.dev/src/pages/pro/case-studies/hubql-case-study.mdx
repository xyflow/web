...
<QandA
  ...
  answer="There was a Pro example that matched our use case. This saved us implementation time on the auto-layout and grouping features, which were key to us. It is also great to get direct support from the React Flow team and able to give back to the maintainers directly."
/>
