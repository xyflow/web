...
React Flow 12 is finally here <Emoji content="✨" /> We are super excited and hope you enjoy the new features as much as we do. The big topics for version 12 are:
...
If you want to **migrate from 11 to 12** or check out the **new features**,
please refer to the [migration guide](/learn/troubleshooting/migrate-to-v12).
