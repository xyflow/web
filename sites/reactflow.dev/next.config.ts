  ...
  env: {
    ...
    NEXT_PUBLIC_EXAMPLES_URL:
      process.env.VERCEL_ENV === 'preview'
        ? `https://example-apps-git-${parsePreviewDeploySlug(process.env.NEXT_PUBLIC_VERCEL_URL) ?? process.env.NEXT_PUBLIC_VERCEL_URL}.vercel.app`
        : process.env.NEXT_PUBLIC_EXAMPLES_URL,
    NEXT_PUBLIC_UI_COMPONENTS_URL:
      process.env.VERCEL_ENV === 'preview'
        ? `https://ui-components-git-${parsePreviewDeploySlug(process.env.NEXT_PUBLIC_VERCEL_URL)}.vercel.app`
