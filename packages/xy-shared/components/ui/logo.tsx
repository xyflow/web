    ...
    <div className={cn('w-8 h-8 text-primary', className)}>
      ...
      >
        ...
        <path
          ...
          className="logo-fg-color"
        />
        <path opacity="0.35" d="M22 9.5H18V10.5H22V9.5Z" className="logo-fg-color" />
        <path
          opacity="0.35"
          d="M29.5 17.5V21.5H30.5V17.5H29.5Z"
          className="logo-fg-color"
        />
        <path opacity="0.35" d="M22 29.5H18V30.5H22V29.5Z" className="logo-fg-color" />
        <path
