...
<div style="height:100vh;">
  ...
  >
    <Panel position="top-right">
      <button class="xy-theme__button" onclick={() => onLayout('DOWN')}>vertical layout</button>
      <button class="xy-theme__button" onclick={() => onLayout('RIGHT')}>horizontal layout</button>
    </Panel>
    <Background />
  </SvelteFlow>
</div>
